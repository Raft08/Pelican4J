...
/**
 * Represents a Pterodactyl {@link be.raft.pelican.entities.Egg Egg}.
...
public interface Egg {
	...
	/**
	 * Represents a Pterodactyl {@link be.raft.pelican.entities.Egg.EggVariable EggVariable}.
	...
	interface EggVariable {
		 ...
		 *
		 * @return Never-null {@link be.raft.pelican.EnvironmentValue EnvironmentValue} containing the variable's default value.
		 */

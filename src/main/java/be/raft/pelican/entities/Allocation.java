...
/**
 * Represents a Pterodactyl {@link be.raft.pelican.entities.Allocation Allocation}.
...
public interface Allocation {
	 ...
	 * <br>This is assigned by a user having control of the {@link be.raft.pelican.client.entities.ClientServer ClientServer}
	...
	default String getPort() {
		return Integer.toUnsignedString(getPortInt());
	}

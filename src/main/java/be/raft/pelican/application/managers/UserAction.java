...
public interface UserAction extends RequestAction<ApplicationUser> {
	...
	/**
	 * Sets the email for this {@link be.raft.pelican.application.entities.ApplicationUser ApplicationUser}.
	 *
	 * <br>The panel requires this value to be <b>unique</b> across the entire panel instance
	 *
	...
	/**
	 * Sets the password for this {@link be.raft.pelican.application.entities.ApplicationUser ApplicationUser}.
	 *

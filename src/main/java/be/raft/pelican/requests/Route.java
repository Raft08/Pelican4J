...
import static be.raft.pelican.requests.Method.*;
...
public class Route {
	...
	public static class Nodes {
		...
		public static final Route LIST_NODES =
				new Route(GET, APPLICATION_PREFIX + "nodes?include=location,servers,allocations");
		public static final Route GET_NODE =
				new Route(GET, APPLICATION_PREFIX + "nodes/{node_id}?include=location,servers,allocations");
		public static final Route GET_CONFIGURATION =
				new Route(GET, APPLICATION_PREFIX + "nodes/{node_id}/configuration");
		public static final Route CREATE_NODE =
				new Route(POST, APPLICATION_PREFIX + "nodes?include=location,servers,allocations");
		...
		public static final Route LIST_ALLOCATIONS =
				new Route(GET, APPLICATION_PREFIX + "nodes/{node_id}/allocations?include=server,node");
		public static final Route CREATE_ALLOCATION =
				new Route(POST, APPLICATION_PREFIX + "nodes/{node_id}/allocations");
		public static final Route DELETE_ALLOCATION =
				new Route(DELETE, APPLICATION_PREFIX + "nodes/{node_id}/allocations/{allocation_id}");
	}

	public static class Locations {

		public static final Route LIST_LOCATIONS =
				new Route(GET, APPLICATION_PREFIX + "locations?include=nodes,servers");
		public static final Route GET_LOCATION =
				new Route(GET, APPLICATION_PREFIX + "locations/{location_id}?include=nodes,servers");
	...
	public static class Servers {
		...
		public static final Route UPDATE_SERVER_BUILD =
				new Route(PATCH, APPLICATION_PREFIX + "servers/{server_id}/build");
		...
		public static final Route REINSTALL_SERVER =
				new Route(POST, APPLICATION_PREFIX + "servers/{server_id}/reinstall");
		public static final Route SAFE_DELETE_SERVER = new Route(DELETE, APPLICATION_PREFIX + "servers/{server_id}");
		public static final Route FORCE_DELETE_SERVER =
	...
	public static class Client {
		...
		public static final Route GET_SERVER =
				new Route(GET, CLIENT_PREFIX + "servers/{server_id}?include=subusers,egg");
		public static final Route GET_WEBSOCKET = new Route(GET, CLIENT_PREFIX + "servers/{server_id}/websocket");
		public static final Route RENAME_SERVER =
				new Route(POST, CLIENT_PREFIX + "servers/{server_id}/settings/rename");
		public static final Route REINSTALL_SERVER =
				new Route(POST, CLIENT_PREFIX + "servers/{server_id}/settings/reinstall");
	}
	...
	public static class Subusers {
		...
		public static final Route GET_SUBUSER =
				new Route(GET, CLIENT_PREFIX + "servers/{server_id}/users/{identifier}");
		public static final Route CREATE_SUBUSER = new Route(POST, CLIENT_PREFIX + "servers/{server_id}/users");
		public static final Route UPDATE_SUBUSER =
				new Route(POST, CLIENT_PREFIX + "servers/{server_id}/users/{identifier}");
		public static final Route DELETE_SUBUSER =
				new Route(DELETE, CLIENT_PREFIX + "servers/{server_id}/users/{identifier}");
	}

	public static class Backups {

		public static final Route LIST_BACKUPS = new Route(GET, CLIENT_PREFIX + "servers/{server_id}/backups");
		public static final Route GET_BACKUP =
				new Route(GET, CLIENT_PREFIX + "servers/{server_id}/backups/{identifier}");
		public static final Route DOWNLOAD_BACKUP =
				new Route(GET, CLIENT_PREFIX + "servers/{server_id}/backups/{identifier}/download");
		public static final Route CREATE_BACKUP = new Route(POST, CLIENT_PREFIX + "servers/{server_id}/backups");
		public static final Route RESTORE_BACKUP =
				new Route(POST, CLIENT_PREFIX + "servers/{server_id}/backups/{identifier}/restore?truncate=true");
		public static final Route LOCK_BACKUP =
				new Route(POST, CLIENT_PREFIX + "servers/{server_id}/backups/{identifier}/lock");
		public static final Route DELETE_BACKUP =
				new Route(DELETE, CLIENT_PREFIX + "servers/{server_id}/backups/{identifier}");
	}

	public static class Schedules {

		public static final Route LIST_SCHEDULES = new Route(GET, CLIENT_PREFIX + "servers/{server_id}/schedules");
		public static final Route GET_SCHEDULE =
				new Route(GET, CLIENT_PREFIX + "servers/{server_id}/schedules/{identifier}");
		public static final Route CREATE_SCHEDULE = new Route(POST, CLIENT_PREFIX + "servers/{server_id}/schedules");
		public static final Route UPDATE_SCHEDULE =
				new Route(POST, CLIENT_PREFIX + "servers/{server_id}/schedules/{identifier}");
		public static final Route DELETE_SCHEDULE =
				new Route(DELETE, CLIENT_PREFIX + "servers/{server_id}/schedules/{identifier}");
		public static final Route CREATE_TASK =
				new Route(POST, CLIENT_PREFIX + "servers/{server_id}/schedules/{identifier}/tasks");
		public static final Route UPDATE_TASK =
				new Route(POST, CLIENT_PREFIX + "servers/{server_id}/schedules/{schedule_id}/tasks/{identifier}");
		public static final Route DELETE_TASK =
				new Route(DELETE, CLIENT_PREFIX + "servers/{server_id}/schedules/{schedule_id}/tasks/{identifier}");
	}

	public static class Files {

		public static final Route LIST_FILES =
				new Route(GET, CLIENT_PREFIX + "servers/{server_id}/files/list?directory={directory}");
		public static final Route GET_CONTENTS =
				new Route(GET, CLIENT_PREFIX + "servers/{server_id}/files/contents?file={file}");
		public static final Route DOWNLOAD_FILE =
				new Route(GET, CLIENT_PREFIX + "servers/{server_id}/files/download?file={file}");
		...
		public static final Route WRITE_FILE =
				new Route(POST, CLIENT_PREFIX + "servers/{server_id}/files/write?file={file}");
		public static final Route COMPRESS_FILES =
				new Route(POST, CLIENT_PREFIX + "servers/{server_id}/files/compress");
		public static final Route DECOMPRESS_FILE =
				new Route(POST, CLIENT_PREFIX + "servers/{server_id}/files/decompress");
		public static final Route DELETE_FILES = new Route(POST, CLIENT_PREFIX + "servers/{server_id}/files/delete");
		public static final Route CREATE_FOLDER =
				new Route(POST, CLIENT_PREFIX + "servers/{server_id}/files/create-folder");
		public static final Route UPLOAD_FILE = new Route(GET, CLIENT_PREFIX + "servers/{server_id}/files/upload");
		public static final Route UPLOAD_FILE_BY_URL =
				new Route(POST, CLIENT_PREFIX + "servers/{server_id}/files/pull?directory={directory}&url={url}");
	}

	public static class Databases {

		public static final Route LIST_DATABASES =
				new Route(GET, APPLICATION_PREFIX + "servers/{server_id}/databases?include=password,host");
		public static final Route GET_DATABASE = new Route(
				GET, APPLICATION_PREFIX + "servers/{server_id}/databases/{database_id}?include=password,host");
		public static final Route CREATE_DATABASE =
				new Route(POST, APPLICATION_PREFIX + "servers/{server_id}/databases?include=password,host");
		public static final Route RESET_PASSWORD =
				new Route(POST, APPLICATION_PREFIX + "servers/{server_id}/databases/{database_id}/reset-password");
		public static final Route DELETE_DATABASE =
				new Route(DELETE, APPLICATION_PREFIX + "servers/{server_id}/databases/{database_id}");
	}

	public static class ClientDatabases {

		public static final Route LIST_DATABASES =
				new Route(GET, CLIENT_PREFIX + "servers/{server_id}/databases?include=password");
		public static final Route CREATE_DATABASE = new Route(POST, CLIENT_PREFIX + "servers/{server_id}/databases");
		public static final Route ROTATE_PASSWORD =
				new Route(POST, CLIENT_PREFIX + "servers/{server_id}/databases/{database_id}/rotate-password");
		public static final Route DELETE_DATABASE =
				new Route(DELETE, CLIENT_PREFIX + "servers/{server_id}/databases/{database_id}");
	}

	public static class ClientAllocations {

		public static final Route LIST_ALLOCATIONS =
				new Route(GET, CLIENT_PREFIX + "servers/{server_id}/network/allocations");
		public static final Route ASSIGN_ALLOCATION =
				new Route(POST, CLIENT_PREFIX + "servers/{server_id}/network/allocations");
		public static final Route SET_NOTE =
				new Route(POST, CLIENT_PREFIX + "servers/{server_id}/network/allocations/{allocation_id}");
		public static final Route SET_PRIMARY =
				new Route(POST, CLIENT_PREFIX + "servers/{server_id}/network/allocations/{allocation_id}/primary");
		public static final Route DELETE_ALLOCATION =

 ...
 * same request. For example, instead of retreving the {@link be.raft.pelican.application.entities.Node Node} of an
 * {@link be.raft.pelican.application.entities.ApplicationServer ApplicationServer} using the node id, you can include the
 * {@link be.raft.pelican.application.entities.Node Node} object in the same request that retrieved the
 ...
 * {@link be.raft.pelican.application.entities.ApplicationEgg ApplicationEgg} of an
 * {@link be.raft.pelican.application.entities.ApplicationServer ApplicationServer} from an

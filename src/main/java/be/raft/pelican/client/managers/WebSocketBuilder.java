...
public class WebSocketBuilder {
	 ...
	 *
	 * <p>By default, the {@link be.raft.pelican.client.entities.ClientServer ClientServer}
	 ...
	 *
	 * <p>However, if your program requires the latest data from the {@link be.raft.pelican.client.entities.ClientServer ClientServer},
	...
	/**
	 * Builds a new {@link be.raft.pelican.client.managers.WebSocketManager WebSocketManager}
	 ...
	 * finished connecting.
	 *
	 * @return A {@link be.raft.pelican.client.managers.WebSocketManager WebSocketManager} that is ready for use
	 */
